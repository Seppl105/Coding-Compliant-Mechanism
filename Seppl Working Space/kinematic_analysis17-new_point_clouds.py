...
four_bar_linkages = [[[44.98086795609999, 8.9721361058, 48.76266023270001, -6.5745049197], [48.76266023270001, -6.5745049197, 57.1212497866, -6.3529435419], [54.9773566933, 9.2371133252, 44.98086795609999, 8.9721361058], [57.1212497866, -6.3529435419, 54.9773566933, 9.2371133252]], [[70.8306984179, 10.926297, 70.0, -1.926297], [81.5918685307, 10.926297, 70.8306984179, 10.926297], [70.0, -1.926297, 80.0, -1.926297], [80.0, -1.926297, 81.5918685307, 10.926297]], [[94.9973161706, 8.2816239081, 94.15355859790002, -2.6606887103], [94.15355859790002, -2.6606887103, 103.8162079062, -2.916816926], [104.9938049054, 8.0166465979, 94.9973161706, 8.2816239081], [103.8162079062, -2.916816926, 104.9938049054, 8.0166465979]], [[119.7252945409, 4.218906421699999, 118.1890944016, -0.2460120996], [118.1890944016, -0.2460120996, 128.1251614082, -0.7716792631999999], [129.7113291796, 3.690595722799999, 119.7252945409, 4.218906421699999], [128.1251614082, -0.7716792631999999, 129.7113291796, 3.690595722799999]]]

coupler_links = [[57.1221460649, 9.861647980299999, 58.28182222409999, 11.491111452], [81.9581750184, -1.519417905999999, 84.85031425109999, -0.3904532768], [105.5888611385, -1.990695703899999, 110.1404174453, 5.529743150999999]]
# ================================================================
...
def solve_mechanism(t21_val, prev_guess_sys2=None, x0_sys1=None):
    """
    ...
    if x0_sys1 == None:
        x0_sys1 = (math.radians(97), math.radians(1.5))
...
# ================================================================
print(angle_deg(sys1_links[1]))

# --- choose input angles you want to see (in degrees) ---
t21_degs = np.linspace(angle_deg(sys1_links[1]) +40 , angle_deg(sys1_links[1]) - 10, 10) #[103.672, 100, 90, 80, 70, 60, 50]# [angle_deg(sys1_links[1])]# [70.0, 80.0 , 90.0, 100.0, 109.473, 120.0, 130.0]   # you can change this list
...
ax_anim.set_title(f"Animated mechanism ({t21_degs[0]}° → {t21_degs[-1]}° loop)")#ax_anim.set_title("Animated mechanism (110° → 60° loop)")
...
four_bar_linkages_new = [[[51.9611993275, 9.1025275692, 48.76266023270001, -6.5745049197], [48.76266023270001, -6.5745049197, 57.1212497866, -6.3529435419], [61.94977947259999, 8.624754939099997, 51.9611993275, 9.1025275692], [57.1212497866, -6.3529435419, 61.94977947259999, 8.624754939099997]], [[77.88477040020001, 9.1325170261, 78.5463904178, -3.729889099599999], [88.61625369379998, 8.333737634, 77.88477040020001, 9.1325170261], [78.5463904178, -3.729889099599999, 88.5069999004, -4.6166014178], [88.5069999004, -4.6166014178, 88.61625369379998, 8.333737634]], [[104.3503899715, 4.2212791429, 114.284006129, 3.0709443941], [114.284006129, 3.0709443941, 114.6372210318, -7.920079150399999], [105.0445272308, -6.731542673799999, 104.3503899715, 4.2212791429], [114.6372210318, -7.920079150399999, 105.0445272308, -6.731542673799999]], [[131.1613298636, -2.354878935499999, 132.0959591361, -6.9832562313], [132.0959591361, -6.9832562313, 141.9298148932, -8.4988532999], [141.0495976405, -3.845570175299999, 131.1613298636, -2.354878935499999], [141.9298148932, -8.4988532999, 141.0495976405, -3.845570175299999]]]


coupler_links_new = [[65.41243863449999, 10.6272512633, 66.7645146177, 9.1535177271], [90.40568343190002, -3.988110489399999, 93.4743936736, -3.5168908724], [119.7262778788, 1.3233782028, 119.3844674672, -7.460517916099999]]
...
# mech 1, new cloud: r3 = top link, r4 = right link
r31_new_line = ordered_linkages_new[0][2]
r41_new_line = ordered_linkages_new[0][3]

t31_meas_deg = angle_deg(r31_new_line)
t41_meas_deg = angle_deg(r41_new_line)

t31_meas_rad = math.radians(t31_meas_deg)
t41_meas_rad = math.radians(t41_meas_deg)

print(f"Measured t31 (new cloud): {t31_meas_deg:.3f} deg")
print(f"Measured t41 (new cloud): {t41_meas_deg:.3f} deg")

# 11.3a) First solve once with default branch just to get Phi2 at this t21
angles12_base, guess_sys2_base = solve_mechanism(t21_meas_rad, prev_guess_sys2=None)

Phi2_ver  = angles12_base["Phi2"]

t12_cad = math.radians(angle_deg(sys2_links[0]))
t22_cad = math.radians(angle_deg(sys2_links[1]))
t42_cad = math.radians(angle_deg(sys2_links[3]))

prev_guess_sys2_ver = (
    t12_cad - Phi2_ver,
    t22_cad - Phi2_ver,
    t42_cad - Phi2_ver,
    math.radians(angle_deg(connector))  # coupler on same branch as CAD
)

# 11.3b) Solve again, but now:
#   - system 1 forced onto the measured new-cloud branch (t41_meas, t31_meas)
#   - system 2 forced onto CAD-like branch in the Phi2_ver frame.
angles12_ver, _ = solve_mechanism(
    t21_meas_rad,
    prev_guess_sys2=prev_guess_sys2_ver,
    x0_sys1=(t41_meas_rad, t31_meas_rad),
)
